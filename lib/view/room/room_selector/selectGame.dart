...
class _SelectGameState extends State<SelectGame> with TickerProviderStateMixin {
  ...
  Widget build(BuildContext context) {
    ...
    return Selector<SearchGame, Tuple5<bool, bool, int, int, List<Game>>>(
          ...
          child: Scaffold(
            ...
            floatingActionButton: FloatingActionButton(
                ...
                onPressed: () {
                  ...
                  roomCreateProvider.setNumOfMember(numofMember);
                        ...
                        children: <Widget>[
                          AnimatedContainer(
                            ...
                            height: value.item2
                                ...
                                ///}
                                ? (value.item3 != 0
                                    ? value.item3 > 1 ? changeHeight(value.item3) : 120
                                    : 50)
                                : height,
                            width: screenSize.width,
                            decoration: BoxDecoration(
                              color: Get.isDarkMode
                                  ? brighten(AppColors.BACKGROUND_COLOR, 5)
                                  : Colors.grey,
