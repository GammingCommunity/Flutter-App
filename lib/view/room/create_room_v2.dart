...
import './provider//setRoomBackground.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return ChangeNotifierProvider(
      create: (context) => SetRoomBackground(),
          child: Consumer<SetRoomBackground>(
        builder: (context, value, child) {
        return Scaffold(
          floatingActionButton: Visibility(
              visible: value.checkroomName,
              child: SizedBox(width:50,height: 50,child: RaisedButton.icon(label: Text(""),icon: Icon(Icons.check), onPressed: () {}))),
                                ...
                                child: Row(
                                  children: <Widget>[
                                    ...
                                    PrivacyRadio(
                                      ...
                                      value: false,
                                      content:
                                          "Only people with access can join group",
                                      groupValue: isRadioSelected,
                                      onChangeType: (bool val) {
                                        setState(() {
                                          isRadioSelected = val;
                                ...
                                child: Row(
                                  children: <Widget>[
                                    AdminRadio(
                                      ...
                                      privacyType: "Free",
                                      content:
                                          "Anyone can invite pr delete guests",
